...
//I set metadata to false so that it doesn't read the WHOLE PROJECT'S mcmod.info file --AstroTibs
@Mod(modid = Reference.MODID, name = Reference.NAME, version = "at_0.9", useMetadata = false, guiFactory = Reference.GUI_FACTORY)
public class bspkrsCoreMod
{
    // config stuff
    private final boolean       allowUpdateCheckDefault          = false;//true; This mod ain't mine originally --AstroTibs
    ...
    private final boolean       generateUniqueNamesFileDefault   = false;//true; This function does not work anymore. --AstroTibs
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        /*
         * new directory structure for a Treecapitator folder so both configs can go in there --AstroTibs
         */
        File configDirectory = new File(event.getModConfigurationDirectory(), "treecapitator");
        File file = new File(configDirectory, "bspkrsCore.cfg");//event.getSuggestedConfigurationFile();
    ...
    public void syncConfig()
    {
        ...
        /*
         * Disabled because I did not write this so I don't want it malfunctioning. --AstroTibs
         */
        /*
