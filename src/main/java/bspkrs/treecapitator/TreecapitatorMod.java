...
@Mod(modid = Reference.MODID, name = Reference.NAME, version = "at_0.9", dependencies = "required-after:bspkrsCore@[@BSCORE_VERSION@,)",
...
public class TreecapitatorMod
{
    ...
    public void preInit(FMLPreInitializationEvent event)
    {
        ...
        File file = new File(configDirectory, "Treecapitator.cfg");//event.getSuggestedConfigurationFile();
