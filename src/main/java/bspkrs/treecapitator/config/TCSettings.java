...
public final class TCSettings
{
    ...
    // The below is stuff I needed to change --AstroTibs
    //public static int            enchantmentID                         = enchantmentIDDefault;
    private static final Rarity  enchantmentWeight                     = Rarity.UNCOMMON;//5; --AstroTibs
    private static final EnumEnchantmentType   enchantmentType         = EnumEnchantmentType.DIGGER;
    private static final EntityEquipmentSlot[] enchantmentSlots     = new EntityEquipmentSlot[]{EntityEquipmentSlot.MAINHAND, EntityEquipmentSlot.OFFHAND};
    ...
    public void handleEnchantmentID(int id)
    {
        ...
        {
            //enchantmentID = id;
            treecapitating = new EnchantmentTreecapitating(enchantmentWeight, enchantmentType, enchantmentSlots);
    ...
    public void syncConfiguration(Configuration config)
    {
        ...
        /*
         * Disabled because enchantments don't work or are too annoying to register --AstroTibs
         */
        /*
