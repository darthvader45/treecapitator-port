...
public class ItemID
{
    ...
    // This is not used so I'm commenting it out --AstroTibs
    /*
	...
	*/
    ...
    public ItemID(Item item, int damage)
    {
    	...
    	this(item.getUnlocalizedName(), damage); // I'm hoping this will do the trick :C --AstroTibs
    }

    public ItemID(Item item)
    {
        //this(GameData.getItemRegistry().getNameForObject(item).toString(), -1);
        this(item.getUnlocalizedName(), -1); // I'm hoping this will do the trick :C --AstroTibs
    }
